function [t_edges, r_edges] = solve_graph_non_lin(graph_data,freq, input_voltage_amp)
...
%     k_in = k.*sign(real(k_in)); % becuase the sqrt() makes a choice and we want the one where real part of k to be positive. see pdf.

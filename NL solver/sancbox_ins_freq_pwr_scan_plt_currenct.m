...
input_idx= 4;
sig_pwr= [-80,-70]; %dBm % for nockit6 params, critical power is ~-55 for couplers, and -32 for main lines
...
for pwr_idx = 1:length(sig_pwr)
    ...
    [t_edges, r_edges] = solve_graph_NL_envelope(graph_data,freq, iterations(pwr_idx));
